...
def main():
    ...
    for a in ds_test.alpha.data:
        for b in ds_test.beta.data:
            ...
            data[(ia, 100-ia-ib, ib)] = -models_dist_comp[ia][ib] ## change here, make ind and spread negative
    ...
    tax._redraw_labels()
    fig.tight_layout()
    fig.savefig(str("SupFig14_CMIP6_JJA_CEU_34ch3_byIM_ind.png"),bbox_inches='tight',dpi=300)
