...
def main():
    ...
    filename =dir+"alpha-beta-scan_SM_JJA_CMIP6_both_sum_ch3_sqrt.comp.csv"
    ...
    for a in ds_test.alpha.data:
        for b in ds_test.beta.data:
            ...
            data[(ia, 100-ia-ib, ib)] = models_perf_comp[ia][ib] ## change here, make ind and spread negative
    ...
    tax._redraw_labels()
    fig.tight_layout()
    fig.savefig(str("SupFig14_CMIP6_JJA_CEU_34ch3_byIM_perf.png"),bbox_inches='tight',dpi=300)
