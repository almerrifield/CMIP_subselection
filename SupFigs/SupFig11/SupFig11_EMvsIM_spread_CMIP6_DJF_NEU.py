# Supplementary Figure 11 : Spread comparison for the CMIP6 DJF NEU case
...
dsT6_djf = xr.open_dataset(dir + 'tas_mon_CMIP6_SSP585_g025_v2_NEU_DJF.nc',use_cftime = True)
dsT6_djf  = dsT6_djf-273.15
dsT6_djf  = dsT6_djf.sortby(dsT6_djf.member)
dsT6_djf  = dsT6_djf.sel(member=members_cmip6)
...
dsT6_djf_base = dsT6_djf.sel(year=slice('1995','2014')).mean('year')
dsT6_djf_fut = dsT6_djf.sel(year=slice('2041','2060')).mean('year')

dsT6_target = dsT6_djf_fut - dsT6_djf_base
...
key_choice = 'ACCESS-ESM1-5-r5i1p1f1'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'CAS-ESM2-0-r3i1p1f1'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'CNRM-CM6-1-r5i1p1f2'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'CNRM-ESM2-1-r3i1p1f2'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'HadGEM3-GC31-MM-r2i1p1f3'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'IPSL-CM6A-LR-r2i1p1f1'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'MIROC-ES2L-r9i1p1f2'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'MPI-ESM1-2-HR-r2i1p1f1'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'MPI-ESM1-2-LR-r4i1p1f1'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))
...
key_choice = 'UKESM1-0-LL-r2i1p1f2'
dict_ind[key_choice] = (dsT6_target_ts_norm.sel(member=key_choice).tas.item(0),dsPr6_target_ts_norm.sel(member=key_choice).pr.item(0))

################################

dsT6_target_ts_spd_all = dsT6_target_ts.sel(member=['ACCESS-CM2-r2i1p1f1','ACCESS-ESM1-5-r5i1p1f1',
       'AWI-CM-1-1-MR-r1i1p1f1', 'CAS-ESM2-0-r3i1p1f1','CESM2-WACCM-r2i1p1f1','CESM2-r2i1p1f1','CMCC-CM2-SR5-r1i1p1f1',
       'CMCC-ESM2-r1i1p1f1', 'CNRM-CM6-1-HR-r1i1p1f2','CNRM-CM6-1-r5i1p1f2','CNRM-ESM2-1-r3i1p1f2',
       'CanESM5-r14i1p2f1','E3SM-1-1-r1i1p1f1', 'FGOALS-f3-L-r1i1p1f1', 'FGOALS-g3-r2i1p1f1',
       'GFDL-CM4-r1i1p1f1', 'GFDL-ESM4-r1i1p1f1','GISS-E2-1-G-r1i1p3f1',
       'HadGEM3-GC31-LL-r3i1p1f3','HadGEM3-GC31-MM-r2i1p1f3', 'INM-CM4-8-r1i1p1f1', 'INM-CM5-0-r1i1p1f1',
       'IPSL-CM6A-LR-r2i1p1f1','KACE-1-0-G-r3i1p1f1','KIOST-ESM-r1i1p1f1','MIROC-ES2L-r9i1p1f2',
       'MIROC6-r12i1p1f1','MPI-ESM1-2-HR-r2i1p1f1','MPI-ESM1-2-LR-r4i1p1f1','MRI-ESM2-0-r1i1p1f1','NESM3-r1i1p1f1',
       'NorESM2-MM-r1i1p1f1','TaiESM1-r1i1p1f1','UKESM1-0-LL-r2i1p1f2']).tas

dsPr6_target_ts_spd_all = dsPr6_target_ts.sel(member=['ACCESS-CM2-r2i1p1f1','ACCESS-ESM1-5-r5i1p1f1',
       'AWI-CM-1-1-MR-r1i1p1f1', 'CAS-ESM2-0-r3i1p1f1','CESM2-WACCM-r2i1p1f1','CESM2-r2i1p1f1','CMCC-CM2-SR5-r1i1p1f1',
       'CMCC-ESM2-r1i1p1f1', 'CNRM-CM6-1-HR-r1i1p1f2','CNRM-CM6-1-r5i1p1f2','CNRM-ESM2-1-r3i1p1f2',
       'CanESM5-r14i1p2f1','E3SM-1-1-r1i1p1f1', 'FGOALS-f3-L-r1i1p1f1', 'FGOALS-g3-r2i1p1f1',
       'GFDL-CM4-r1i1p1f1', 'GFDL-ESM4-r1i1p1f1','GISS-E2-1-G-r1i1p3f1',
       ...
       'IPSL-CM6A-LR-r2i1p1f1','KACE-1-0-G-r3i1p1f1','KIOST-ESM-r1i1p1f1','MIROC-ES2L-r9i1p1f2',
       'MIROC6-r12i1p1f1','MPI-ESM1-2-HR-r2i1p1f1','MPI-ESM1-2-LR-r4i1p1f1','MRI-ESM2-0-r1i1p1f1','NESM3-r1i1p1f1',
       'NorESM2-MM-r1i1p1f1','TaiESM1-r1i1p1f1','UKESM1-0-LL-r2i1p1f2']).pr
...
plt.savefig('SupFig11_EMvsIM_spread_CMIP6_DJF_NEU.png',bbox_inches='tight',dpi=300)
