# Supplementary Figure 7: predictor scatters vs. JJA CEU PR change
...
fig.suptitle('Predictor RMSE from Observed vs. JJA Central European PR Change \n(2041/2060 - 1995/2014)\n', fontsize=14,fontweight='bold')
...
plt.ylabel('JJA CEU PR Change (mm/day)',fontsize=11)
...
plt.plot(dsPr5_jja_base_delta,dsPr5_target_ts.pr,'x',label='CMIP5',markersize=4)
plt.plot(dsPr6_jja_base_delta,dsPr6_target_ts.pr,'.',label='CMIP6',fillstyle='none')
plt.xlim([0,2.2])
plt.ylim([-0.75,0.5])
...
plt.plot(dsSW5_jja_base_delta,dsPr5_target_ts.pr,'x',label='CMIP5',markersize=4)
plt.plot(dsSW6_jja_base_delta,dsPr6_target_ts.pr,'.',label='CMIP6',fillstyle='none')
plt.xlim([0,60])
plt.ylim([-0.75,0.5])
...
plt.xticks(fontsize=11)
plt.yticks(fontsize=11)
plt.ylabel('JJA CEU PR Change (mm/day)',fontsize=12)
...
plt.savefig('SupFig7_predictor_scatter_JJA_CEU_PR.png',dpi=300)
plt.close()
