# Supplementary Figure 8: predictor scatters vs. DJF NEU SAT change
...
fig.suptitle('Predictor RMSE from Observed vs. DJF Northern European SAT Change \n(2041/2060 - 1995/2014)\n', fontsize=14,fontweight='bold')
...
plt.ylabel('DJF NEU SAT Change (˚C)',fontsize=11)
...
plt.plot(dsPr5_djf_base_delta,dsT5_target_ts.tas,'x',label='CMIP5',markersize=4)
plt.plot(dsPr6_djf_base_delta,dsT6_target_ts.tas,'.',label='CMIP6',fillstyle='none')
plt.xlim([0,2])
plt.ylim([0,8.5])
...
plt.plot(dsP5_djf_base_delta,dsT5_target_ts.tas,'x',label='CMIP5',markersize=4)
plt.plot(dsP6_djf_base_delta,dsT6_target_ts.tas,'.',label='CMIP6',fillstyle='none')
plt.xlim([0,10])
plt.ylim([0,8.5])
...
plt.xticks(fontsize=11)
plt.yticks(fontsize=11)
plt.ylabel('DJF NEU SAT Change (˚C)',fontsize=12)
...
plt.ylabel('DEU NEU SAT Change (˚C)',fontsize=11)
plt.legend(fontsize=11,loc=4)
plt.xticks(fontsize=11)
plt.yticks(fontsize=11)
plt.subplots_adjust(wspace=0.1, hspace=0.4)
plt.savefig('SupFig8_predictor_scatter_DJF_NEU_SAT.png',dpi=300)
plt.close()
