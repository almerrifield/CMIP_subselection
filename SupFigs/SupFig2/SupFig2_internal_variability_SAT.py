# Supplementary Figure 2: makes internal variability across SMILEs plots for tas
...
dsT6_clim_access_std.tas.plot.pcolormesh(ax=f3_ax1, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax1.coastlines();
f3_ax1.set_title('a) ACCESS-ESM1-5 (10) $\sigma$',fontsize=11)

f3_ax2 = fig3.add_subplot(gs[0, 1],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_can_std.tas.plot.pcolormesh(ax=f3_ax2, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax2.coastlines();
f3_ax2.set_title('b) CanESM5 (25) $\sigma$',fontsize=11)

f3_ax3 = fig3.add_subplot(gs[0, 2],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_cesm_std.tas.plot.pcolormesh(ax=f3_ax3, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax3.coastlines();
f3_ax3.set_title(' c) CESM2 (5) $\sigma$',fontsize=11)

f3_ax4 = fig3.add_subplot(gs[1, 0],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_cnrm_std.tas.plot.pcolormesh(ax=f3_ax4, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax4.coastlines();
f3_ax4.set_title('d) CNRM-CM6-1 (6) $\sigma$',fontsize=11)

f3_ax5 = fig3.add_subplot(gs[1, 1],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_cnrm_e_std.tas.plot.pcolormesh(ax=f3_ax5, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax5.coastlines();
f3_ax5.set_title('e) CNRM-ESM2-1 (5) $\sigma$',fontsize=11)

f3_ax6 = fig3.add_subplot(gs[1, 2],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_earth_std.tas.plot.pcolormesh(ax=f3_ax6, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax6.coastlines();
f3_ax6.set_title('f) EC-Earth3 (8) $\sigma$',fontsize=11)

f3_ax7 = fig3.add_subplot(gs[2, 0],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_giss_std.tas.plot.pcolormesh(ax=f3_ax7, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax7.coastlines();
f3_ax7.set_title('g) GISS-E2-1-G (5) $\sigma$',fontsize=11)

f3_ax8 = fig3.add_subplot(gs[2, 1],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_ipsl_std.tas.plot.pcolormesh(ax=f3_ax8, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax8.coastlines();
f3_ax8.set_title('h) IPSL-CM6A-LR (6) $\sigma$',fontsize=11)

f3_ax9 = fig3.add_subplot(gs[2, 2],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_miroc_e_std.tas.plot.pcolormesh(ax=f3_ax9, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax9.coastlines();
f3_ax9.set_title('i) MIROC-ES2L (10) $\sigma$',fontsize=11)

f3_ax10 = fig3.add_subplot(gs[3, 0],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_miroc_std.tas.plot.pcolormesh(ax=f3_ax10, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax10.coastlines();
f3_ax10.set_title('j) MIROC6 (50) $\sigma$',fontsize=11)

f3_ax11 = fig3.add_subplot(gs[3, 1],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT6_clim_mpi_std.tas.plot.pcolormesh(ax=f3_ax11, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax11.coastlines();
f3_ax11.set_title('k) MPI-ESM1-2-LR (10) $\sigma$',fontsize=11)

f3_ax12 = fig3.add_subplot(gs[3, 2],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
pcm = dsT6_clim_ukesm_std.tas.plot.pcolormesh(ax=f3_ax12, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax12.coastlines();
...
cmap = plt.get_cmap('BuPu')
dsT5_clim_can_std.tas.plot.pcolormesh(ax=f3_ax13, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax13.coastlines();
f3_ax13.set_title('m) CanESM2 (5) $\sigma$',fontsize=11)

f3_ax14 = fig3.add_subplot(gs[4, 1],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT5_clim_ccsm4_std.tas.plot.pcolormesh(ax=f3_ax14, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax14.coastlines();
f3_ax14.set_title('n) CCSM4 (6) $\sigma$',fontsize=11)

f3_ax15 = fig3.add_subplot(gs[4, 2],projection=ccrs.PlateCarree())
cmap = plt.get_cmap('BuPu')
dsT5_clim_cnrm_std.tas.plot.pcolormesh(ax=f3_ax15, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax15.coastlines();
...
cmap = plt.get_cmap('BuPu')
dsT5_clim_csiro_std.tas.plot.pcolormesh(ax=f3_ax16, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax16.coastlines();
...
cmap = plt.get_cmap('BuPu')
pcm = dsT5_clim_earth_std.tas.plot.pcolormesh(ax=f3_ax17, transform=ccrs.PlateCarree(), cmap=cmap,vmin=0,vmax=1.2,add_colorbar=False)
f3_ax17.coastlines();
...
cbar.set_label(label='SAT Standard Deviation (˚C)',size=11)

plt.savefig('SupFig2_IV_SAT_1905_2005.png',bbox_inches='tight',dpi=300)
