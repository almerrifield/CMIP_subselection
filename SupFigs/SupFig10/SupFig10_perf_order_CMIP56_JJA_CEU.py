...
plt.title('a) CMIP6 Central European Summer Case' ,fontsize=14,fontweight='bold',loc='left')
...
plt.plot([-0.5,0.5],[gfdl3.isel(member=0),gfdl3.isel(member=0)],linewidth=2,color='indigo')

rng = [64]
noresm1me = dsDelta5_1c.isel(member=rng)
plt.plot([1.5,2.5],[noresm1me.isel(member=0),noresm1me.isel(member=0)],linewidth=2,color='darkgoldenrod')

rng = [63]
noresm1m = dsDelta5_1c.isel(member=rng)
plt.plot([3.5,4.5],[noresm1m.isel(member=0),noresm1m.isel(member=0)],linewidth=2,color='darkgoldenrod')

rng = np.arange(8,11)
cesm1 = dsDelta5_1c.isel(member=rng)
plt.plot([5.5,6.5],[cesm1.isel(member=0),cesm1.isel(member=0)],linewidth=2,color='darkgoldenrod',alpha=0.3)
plt.plot([5.5,6.5],[cesm1.isel(member=1),cesm1.isel(member=1)],linewidth=2,color='darkgoldenrod',alpha=0.3)
plt.plot([5.5,6.5],[cesm1.isel(member=2),cesm1.isel(member=2)],linewidth=2,color='darkgoldenrod',alpha=0.3)
f = np.mean(cesm1)
plt.plot([6,6],[f,f],"*",markersize=9,color='w')
plt.plot([6,6],[f,f],"*",markersize=7,color='darkgoldenrod')

rng = [33]
gfdlm = dsDelta5_1c.isel(member=rng)
plt.plot([7.5,8.5],[gfdlm.isel(member=0),gfdlm.isel(member=0)],linewidth=2,color='indigo')

rng = [0]
access_0 = dsDelta5_1c.isel(member=rng)
plt.plot([9.5,10.5],[access_0.isel(member=0),access_0.isel(member=0)],linewidth=2,color='tab:red')
...
plt.plot([13.5,14.5],[miroc5.isel(member=0),miroc5.isel(member=0)],linewidth=2,color='lightsalmon',alpha=0.3)
plt.plot([13.5,14.5],[miroc5.isel(member=1),miroc5.isel(member=1)],linewidth=2,color='lightsalmon',alpha=0.3)
plt.plot([13.5,14.5],[miroc5.isel(member=2),miroc5.isel(member=2)],linewidth=2,color='lightsalmon',alpha=0.3)
f = np.mean(miroc5)
plt.plot([14,14],[f,f],"*",markersize=9,color='w')
plt.plot([14,14],[f,f],"*",markersize=7,color='lightsalmon')

rng = [32]
gfdlg = dsDelta5_1c.isel(member=rng)
plt.plot([15.5,16.5],[gfdlg.isel(member=0),gfdlg.isel(member=0)],linewidth=2,color='indigo')

rng = np.arange(44,48)
hadgemes = dsDelta5_1c.isel(member=rng)
plt.plot([17.5,18.5],[hadgemes.isel(member=0),hadgemes.isel(member=0)],linewidth=2,color='tab:red',alpha=0.3)
plt.plot([17.5,18.5],[hadgemes.isel(member=1),hadgemes.isel(member=1)],linewidth=2,color='tab:red',alpha=0.3)
plt.plot([17.5,18.5],[hadgemes.isel(member=2),hadgemes.isel(member=2)],linewidth=2,color='tab:red',alpha=0.3)
plt.plot([17.5,18.5],[hadgemes.isel(member=3),hadgemes.isel(member=3)],linewidth=2,color='tab:red',alpha=0.3)
f = np.mean(hadgemes)
plt.plot([18,18],[f,f],"*",markersize=9,color='w')
plt.plot([18,18],[f,f],"*",markersize=7,color='tab:red')

rng = np.arange(2,8)
ccsm4 = dsDelta5_1c.isel(member=rng)
plt.plot([19.5,20.5],[ccsm4.isel(member=0),ccsm4.isel(member=0)],linewidth=2,color='darkgoldenrod',alpha=0.3)
plt.plot([19.5,20.5],[ccsm4.isel(member=1),ccsm4.isel(member=1)],linewidth=2,color='darkgoldenrod',alpha=0.3)
plt.plot([19.5,20.5],[ccsm4.isel(member=2),ccsm4.isel(member=2)],linewidth=2,color='darkgoldenrod',alpha=0.3)
plt.plot([19.5,20.5],[ccsm4.isel(member=3),ccsm4.isel(member=3)],linewidth=2,color='darkgoldenrod',alpha=0.3)
plt.plot([19.5,20.5],[ccsm4.isel(member=4),ccsm4.isel(member=4)],linewidth=2,color='darkgoldenrod',alpha=0.3)
plt.plot([19.5,20.5],[ccsm4.isel(member=5),ccsm4.isel(member=5)],linewidth=2,color='darkgoldenrod',alpha=0.3)
f = np.mean(ccsm4)
plt.plot([20,20],[f,f],"*",markersize=9,color='w')
plt.plot([20,20],[f,f],"*",markersize=7,color='darkgoldenrod')

rng = np.arange(26,31)
canesm2 = dsDelta5_1c.isel(member=rng)
plt.plot([21.5,22.5],[canesm2.isel(member=0),canesm2.isel(member=0)],linewidth=2,color='dodgerblue',alpha=0.3)
plt.plot([21.5,22.5],[canesm2.isel(member=1),canesm2.isel(member=1)],linewidth=2,color='dodgerblue',alpha=0.3)
plt.plot([21.5,22.5],[canesm2.isel(member=2),canesm2.isel(member=2)],linewidth=2,color='dodgerblue',alpha=0.3)
plt.plot([21.5,22.5],[canesm2.isel(member=3),canesm2.isel(member=3)],linewidth=2,color='dodgerblue',alpha=0.3)
plt.plot([21.5,22.5],[canesm2.isel(member=4),canesm2.isel(member=4)],linewidth=2,color='dodgerblue',alpha=0.3)
f = np.mean(canesm2)
plt.plot([22,22],[f,f],"*",markersize=9,color='w')
plt.plot([22,22],[f,f],"*",markersize=7,color='dodgerblue')

rng = [65]
bccm = dsDelta5_1c.isel(member=rng)
plt.plot([23.5,24.5],[bccm.isel(member=0),bccm.isel(member=0)],linewidth=2,color='silver')

rng = [61]
mpimr = dsDelta5_1c.isel(member=rng)
plt.plot([25.5,26.5],[mpimr.isel(member=0),mpimr.isel(member=0)],linewidth=2,color='tab:orange')

rng = np.arange(58,61)
mpilr = dsDelta5_1c.isel(member=rng)
plt.plot([27.5,28.5],[mpilr.isel(member=0),mpilr.isel(member=0)],linewidth=2,color='tab:orange',alpha=0.3)
plt.plot([27.5,28.5],[mpilr.isel(member=1),mpilr.isel(member=1)],linewidth=2,color='tab:orange',alpha=0.3)
plt.plot([27.5,28.5],[mpilr.isel(member=2),mpilr.isel(member=2)],linewidth=2,color='tab:orange',alpha=0.3)
f = np.mean(mpilr)
plt.plot([28,28],[f,f],"*",markersize=9,color='w')
plt.plot([28,28],[f,f],"*",markersize=7,color='tab:orange')

rng = [66]
bcc = dsDelta5_1c.isel(member=rng)
plt.plot([29.5,30.5],[bcc.isel(member=0),bcc.isel(member=0)],linewidth=2,color='silver')

rng = np.arange(16,26)
csiro = dsDelta5_1c.isel(member=rng)
plt.plot([31.5,32.5],[csiro.isel(member=0),csiro.isel(member=0)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=1),csiro.isel(member=1)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=2),csiro.isel(member=2)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=3),csiro.isel(member=3)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=4),csiro.isel(member=4)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=5),csiro.isel(member=5)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=6),csiro.isel(member=6)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=7),csiro.isel(member=7)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=8),csiro.isel(member=8)],linewidth=2,color='deeppink',alpha=0.3)
plt.plot([31.5,32.5],[csiro.isel(member=9),csiro.isel(member=9)],linewidth=2,color='deeppink',alpha=0.3)
f = np.mean(csiro)
plt.plot([32,32],[f,f],"*",markersize=9,color='w')
plt.plot([32,32],[f,f],"*",markersize=7,color='deeppink')

rng = np.arange(39,44)
gissr = dsDelta5_1c.isel(member=rng)
plt.plot([33.5,34.5],[gissr.isel(member=0),gissr.isel(member=0)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([33.5,34.5],[gissr.isel(member=1),gissr.isel(member=1)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([33.5,34.5],[gissr.isel(member=2),gissr.isel(member=2)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([33.5,34.5],[gissr.isel(member=3),gissr.isel(member=3)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([33.5,34.5],[gissr.isel(member=4),gissr.isel(member=4)],linewidth=2,color='blueviolet',alpha=0.3)
f = np.mean(gissr)
plt.plot([34,34],[f,f],"*",markersize=9,color='w')
...
plt.plot([35.5,36.5],[mri1.isel(member=0),mri1.isel(member=0)],linewidth=2,color='palevioletred')

rng = np.arange(34,39)
gissh = dsDelta5_1c.isel(member=rng)
plt.plot([37.5,38.5],[gissh.isel(member=0),gissh.isel(member=0)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([37.5,38.5],[gissh.isel(member=1),gissh.isel(member=1)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([37.5,38.5],[gissh.isel(member=2),gissh.isel(member=2)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([37.5,38.5],[gissh.isel(member=3),gissh.isel(member=3)],linewidth=2,color='blueviolet',alpha=0.3)
plt.plot([37.5,38.5],[gissh.isel(member=4),gissh.isel(member=4)],linewidth=2,color='blueviolet',alpha=0.3)
f = np.mean(gissh)
plt.plot([38,38],[f,f],"*",markersize=9,color='w')
plt.plot([38,38],[f,f],"*",markersize=7,color='blueviolet')

rng = [54]
miroc = dsDelta5_1c.isel(member=rng)
plt.plot([39.5,40.5],[miroc.isel(member=0),miroc.isel(member=0)],linewidth=2,color='lightsalmon')

rng = [67]
inmcm = dsDelta5_1c.isel(member=rng)
plt.plot([41.5,42.5],[inmcm.isel(member=0),inmcm.isel(member=0)],linewidth=2,color='mediumseagreen')

rng = [52]
ipsl5am = dsDelta5_1c.isel(member=rng)
plt.plot([43.5,44.5],[ipsl5am.isel(member=0),ipsl5am.isel(member=0)],linewidth=2,color='royalblue')

rng = np.arange(11,16)
cnrm5 = dsDelta5_1c.isel(member=rng)
plt.plot([45.5,46.5],[cnrm5.isel(member=0),cnrm5.isel(member=0)],linewidth=2,color='cornflowerblue',alpha=0.3)
plt.plot([45.5,46.5],[cnrm5.isel(member=1),cnrm5.isel(member=1)],linewidth=2,color='cornflowerblue',alpha=0.3)
plt.plot([45.5,46.5],[cnrm5.isel(member=2),cnrm5.isel(member=2)],linewidth=2,color='cornflowerblue',alpha=0.3)
plt.plot([45.5,46.5],[cnrm5.isel(member=3),cnrm5.isel(member=3)],linewidth=2,color='cornflowerblue',alpha=0.3)
plt.plot([45.5,46.5],[cnrm5.isel(member=4),cnrm5.isel(member=4)],linewidth=2,color='cornflowerblue',alpha=0.3)
f = np.mean(cnrm5)
plt.plot([46,46],[f,f],"*",markersize=9,color='w')
plt.plot([46,46],[f,f],"*",markersize=7,color='cornflowerblue')
...
ax.set_xticks(xticks)
labels = ['GFDL-CM3','NorESM1-ME','NorESM1-M','CESM1-CAM5','GFDL-ESM2M','ACCESS1-0','ACCESS1-3','MIROC5','GFDL-ESM2G','HadGEM2-ES',
'CCSM4','CanESM2','bcc-csm1-1-m','MPI-ESM-MR','MPI-ESM-LR',"bcc-csm1-1","CSIRO-Mk3-6-0","GISS-E2-R","MRI-CGCM3","GISS-E2-H",
"MIROC-ESM","inmcm4","IPSL-CM5A-MR","CNRM-CM5","IPSL-CM5A-LR","IPSL-CM5B-LR"]
ax.set_xticklabels(labels,fontsize=8,rotation = 90)
plt.subplots_adjust(wspace=0.05, hspace=0)
ax.set_yticklabels('')
plt.title('b) CMIP5 Central European Summer Case' ,fontsize=14,fontweight='bold',loc='left')

plt.savefig('SupFig10_perf_order_CMIP56_JJA_CEU.png',bbox_inches='tight',dpi=300)
